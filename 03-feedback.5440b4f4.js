...
const email = (0, _storageJs.load)(localStorageKey)?.email || "";
const message = (0, _storageJs.load)(localStorageKey)?.message || "";
let formData = {
    message: message,
    email: email
};
...
emailInput.addEventListener("input", (0, _lodashThrottleDefault.default)((evt)=>{
    formData = {
        ...formData,
        email: evt.target.value
    };
    (0, _storageJs.save)(localStorageKey, formData);
}, 500));
const messageInput = document.querySelector("textarea");
messageInput.value = message;
messageInput.addEventListener("input", (0, _lodashThrottleDefault.default)((evt)=>{
    formData = {
        ...formData,
...
form.addEventListener("submit", (evt)=>{
    ...
    evt.preventDefault();
    (0, _storageJs.remove)(localStorageKey);
    form.reset();
});
